...
pub fn Section(
    ...
    let page_id = 3; // this must be unique
    view! {
    ...
    <div class="page" 
        ...
        <div class="page_row">
            <img class="page_row_item rounded_box" src="images/about_sitting.png"></img>
        ...
        <div class="page_row">     
            ...
            <img class="page_row_item rounded_box" src="/images/about_cafe_light.png"></img>
        </div>
        <div class="page_row_spacer" style="min-height:100px;"></div>
