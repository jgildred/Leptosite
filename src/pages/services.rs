...
pub fn Section(
    ...
    let page_id = 2; // this must be unique
    view! {
    ...
    <div class="page" 
        ...
        <div class="page_row">
            <img class="page_row_item rounded_box" src="images/serv_coffee.png"></img>
        ...
        <div class="page_row">     
            ...
            <img class="page_row_item rounded_box" src="/images/serv_wine.png"></img>
        </div>
        <div class="page_row_spacer" style="min-height:20px;"></div>
        <div class="page_row_title">
            Lorem ipsum
        ...
        <div class="page_row">
            <img class="page_row_item rounded_box" src="images/serv_dna.png"></img>
            <p class="page_row_item page_text">
                Lorem ipsum dolor sit amet, consectetur adipiscing 
                elit, sed do eiusmod tempor incididunt ut labore et 
                dolore magna aliqua. Ut enim ad minim veniam, quis 
